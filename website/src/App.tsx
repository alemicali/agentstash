...
const INSTALL_COMMANDS: Record<InstallTab, string> = {
  curl: "curl -fsSL https://agentstash.io/install.sh | bash",
  npm: "npm install -g agentstash",
  pnpm: "pnpm add -g agentstash",
  bun: "bun add -g agentstash",
  npx: "npx agentstash setup",
};
...
const SCENE_SETUP: TermLine[] = [
  { text: "$ agentstash setup", delay: 0, color: "white" },
  { text: "", delay: 300 },
  { text: "  agentstash v0.1.0", delay: 500, color: "dim" },
  { text: "", delay: 700 },
  ...
  { text: "  [3/5] Bucket \"my-agentstash\" created", delay: 2500 },
...
const SCENE_BACKUP: TermLine[] = [
  { text: "$ agentstash backup", delay: 0, color: "white" },
  { text: "", delay: 300 },
...
const SCENE_RESTORE: TermLine[] = [
  ...
  { text: "$ npm install -g agentstash", delay: 800, color: "white" },
  { text: "$ agentstash restore", delay: 1600, color: "white" },
  { text: "", delay: 2000 },
  ...
  { text: "  # agentstash restore --only workspace", delay: 6900, color: "dim" },
  { text: "  # agentstash restore --at \"3 days ago\"", delay: 7200, color: "dim" },
];

const SCENE_STATUS: TermLine[] = [
  { text: "$ agentstash status", delay: 0, color: "white" },
  { text: "", delay: 300 },
  { text: "  OpenClaw dir      ~/.openclaw (847 files)", delay: 600 },
  { text: "  Local size        156.3MB", delay: 800 },
  { text: "  Storage           R2 / my-agentstash", delay: 1000 },
  { text: "", delay: 1200 },
...
function App() {
  ...
  useEffect(() => {
    ...
    // Extra pause so the terminal fades in before text starts typing
    const initialDelay = scene === "setup" ? 1200 : 400;
    const timers = lines.map((l, i) =>
      setTimeout(() => setVisibleLines(i + 1), l.delay + initialDelay)
    );
...
/* terminal */
.tw { margin-top: 3rem; width: 100%; max-width: 660px; animation: fd 0.6s ease 0.6s both; }
  ...
  .term-tabs { display: none; }
      ...
      <nav>
        <a href="/" className="n-logo">
          <img src="/logo.png" alt="Agentstash" style={{ height: "28px", width: "auto" }} />
        </a>
        <ul className="n-links">
          <li><a href="#install">Install</a></li>
          <li><a href="#features">Why</a></li>
          <li>
            <a href="https://github.com/alemicali/agentstash" target="_blank" rel="noopener" className="n-gh">
      ...
      <section className="hero">
        ...
        <div className="acts">
          ...
          <a href="https://github.com/alemicali/agentstash" target="_blank" rel="noopener" className="btn btn-o">
            Source code
          </a>
        </div>
      ...
      <section className="inst" id="install">
        <h2>Get it</h2>
        <p className="ssub">
          Requires Node 18+. Then run <code style={{ fontFamily: "var(--mono)", color: "var(--tx)" }}>agentstash setup</code>.
        </p>
        <div className="icard">
          <div className="itabs">
      ...
      <section className="feats" id="features">
        <h2>Why agentstash</h2>
        <p className="ssub">
          AI coding agents store important data locally. If you lose it, you lose everything.
          Don't.
        </p>
        <div className="fg">
          {([
      ...
      <footer>
        <div className="ftr">
          <div className="fl">
            <a href="https://github.com/alemicali/agentstash" target="_blank" rel="noopener">GitHub</a>
            <a href="https://github.com/alemicali/agentstash/issues" target="_blank" rel="noopener">Issues</a>
            <a href="https://openclaw.ai" target="_blank" rel="noopener">OpenClaw</a>
          </div>
          <p>MIT license {"\u00B7"} community project</p>
