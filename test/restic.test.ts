...
describe("restic", () => {
  ...
  describe("listSnapshots", () => {
    it("returns parsed snapshots", async () => {
      const snapshots = [
        { id: "abc", short_id: "abc1", time: "2026-02-17T10:00:00Z", hostname: "test", tags: ["agentstash"], paths: ["/home/.openclaw"] },
    ...
    it("passes tag filters", async () => {
      ...
      const { listSnapshots } = await import("../src/core/restic.js");
      await listSnapshots(mockOpts, { tags: ["agentstash"] });
