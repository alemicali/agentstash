...
vi.mock("../src/utils/platform.js", () => ({
  getAgentstashConfigPath: () => configPath,
}));
...
function makeConfig(overrides?: Partial<AgentstashConfig>): AgentstashConfig {
  return {
    version: 1,
...
describe("config I/O", () => {
  beforeEach(async () => {
    tempDir = await mkdtemp(join(tmpdir(), "agentstash-test-"));
