...
export function getAgentstashDir(): string {
  return join(homedir(), ".agentstash");
}

export function getAgentstashBinDir(): string {
  return join(getAgentstashDir(), "bin");
}

export function getAgentstashConfigPath(): string {
  return join(getAgentstashDir(), "config.json");
}
...
export function getResticBinaryPath(): string {
  return join(getAgentstashBinDir(), getResticBinaryName());
}

export function getTempDir(): string {
  return join(tmpdir(), "agentstash");
}
