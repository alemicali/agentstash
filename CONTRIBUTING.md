...
```bash
git clone https://github.com/<your-username>/agentstash
cd agentstash
npm install
...
Open an issue at https://github.com/alemicali/agentstash/issues with:

1. What you expected
2. What happened
3. Output of `agentstash doctor`
